...
public class Detection {
    public static boolean networkAvailableStatus(Context context) {
        return ((ConnectivityManager) context.getSystemService
                (Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo() != null;
    }

    /*This entire method will simply test if there is a valid connection based on url parameters */
